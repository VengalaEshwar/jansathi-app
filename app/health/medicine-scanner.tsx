  ...
  return (
    <View className="flex-1 bg-light-background dark:bg-background">
      <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 40 }}>
        ...
        {/* Header */}
        <View className="mb-6">
          <Text className="text-2xl font-bold text-light-foreground dark:text-foreground mb-1">{t.medicine.title}</Text>
        ...
        {isAnalyzing && (
          <View className="mt-6 p-6 rounded-2xl bg-secondary border border-light-border dark:border-border items-center">
            ...
            <Text className="mt-2 text-lg text-light-foreground dark:text-foreground">{t.medicine.analyzing}</Text>
          </View>
        )}
          ...
          <View className="mt-6">
            <View className="p-5 rounded-2xl bg-light-card dark:bg-card border border-light-border dark:border-border">
              <View className="flex-row justify-between items-center mb-3">
                <Text className="text-light-foreground dark:text-foreground text-lg font-semibold">{t.medicine.analysisReport}</Text>
            ...
            <View className="mt-3 p-4 rounded-xl bg-secondary border border-light-border dark:border-border">
        ...
        {!selectedImage && !isAnalyzing && (
          <View className="mt-6 p-5 rounded-2xl bg-secondary border border-light-border dark:border-border">
            <Text className="font-semibold mb-2 text-light-foreground dark:text-foreground">{t.medicine.howToUse}</Text>
        ...
        <View className="mt-6">
          <View className="flex-row items-center gap-2 mb-3">
            ...
            <Text className="text-light-foreground dark:text-foreground font-bold text-base">{t.medicine.history}</Text>
          </View>
