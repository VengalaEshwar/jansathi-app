...
if (!useSpeechRecognitionEvent) {
  useSpeechRecognitionEvent = (_e: string, _cb: any) => {};
}
...
export default function VoiceChatbot() {
  ...
  const [showMenu, setShowMenu] = useState(false); // kept from your code, unused for now
  ...
  const sidePad = containerWidth ? Math.max(16, (width - containerWidth) / 2) : 16;
  ...
  useEffect(() => {
    if (isNativeVoiceAvailable) requestNativePermission();
  ...
  return (
    <KeyboardAvoidingView
      className={`flex-1 bg-[#F8FAFC] dark:bg-[#0F172A] pb-12`}
    ...
    >
        ...
        >
          ...
          {messages.length === 0 && (
            <View style={{ alignItems: "center", paddingVertical: 40 }}>
              ...
              <Text
                className="font-bold text-[#0F172A] dark:text-white text-base"
                style={S.mb6}
              >
                {t.chat.botName}
              </Text>
              ...
              <Text
                className="text-[#64748B] dark:text-[#94A3B8] text-sm text-center"
      ...
      {/* ── Controls ── */}
      <View
        className="bg-[#F8FAFC] dark:bg-[#0F172A] border-t border-[#E2E8F0] dark:border-[#334155]"
        style={{
          paddingHorizontal: sidePad,
          paddingBottom: showControls ? 28 : 16,
          paddingTop: 12,
        }}
      >
        {/* Centered container on wide */}
        <View
          style={
            containerWidth
              ? {
        ...
        >
          ...
          <View style={{ alignItems: "center", marginBottom: showControls ? 10 : -1000000 }}>
            <AnimatedPressable
              onPress={toggleControls}
              soundType="soft"
              className="bg-white dark:bg-[#1E293B] border border-[#E2E8F0] dark:border-[#334155] rounded-full px-4 py-2"
              style={{
                flexDirection: "row",
                alignItems: "center",
                gap: 8,
          ...
          {showControls && (
            <>
              ...
              <View style={{ flexDirection: "row", gap: 8 }}>
                ...
                <AnimatedPressable
                  onPress={() => {
                    if (canSend) handleInput(textInput);
                  }}
                  disabled={!canSend}
                  ...
                  style={{
                    ...
                    alignItems: "center",
                    justifyContent: "center",
                    backgroundColor: canSend ? "#8B5CF6" : "#E2E8F0",
