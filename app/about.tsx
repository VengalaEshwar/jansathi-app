    ...
    >
      ...
      >
        <View style={{ flexDirection: "row", alignItems: "center", gap: 12, marginBottom: 8 }}>
          ...
          <Text style={{ fontWeight: "700", fontSize: 14, color: "#0F172A" }} className="dark:text-white">
            {title}
          </Text>
        </View>
...
function ValueBox({
  ...
  const { playClick } = useSound();
  return (
    <Animated.View style={{ flex: 1, opacity: anim.opacity, transform: [...anim.transform, { scale }] }}>
      <Pressable
        onPressIn={() => {
          playClick("soft");
          Animated.spring(scale, {
      ...
      >
        ...
        <Text style={{ fontWeight: "700", fontSize: 13, textAlign: "center", marginBottom: 4, color: "#0F172A" }} className="dark:text-white">
          {title}
        </Text>
        <Text style={{ color: "#64748B", fontSize: 12, textAlign: "center", lineHeight: 16 }} className="dark:text-[#94A3B8]">
          {text}
        </Text>
      </Pressable>
    </Animated.View>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={{ marginTop: 20, fontSize: 28, fontWeight: "800", color: "#0F172A", letterSpacing: 0.5 }} className="dark:text-white">
          JanSathi
        </Text>
        <Text style={{ fontSize: 13, color: "#64748B", marginTop: 4, fontWeight: "600", letterSpacing: 1 }} className="dark:text-[#94A3B8]">
          VERSION 1.0.0
        </Text>

        {/* WEB EXCLUSIVE DOWNLOAD BUTTON */}
        {Platform.OS === "web" && (
  <AnimatedPressable
    onPress={() =>
      Linking.openURL("https://github.com/VengalaEshwar/jansathi-app/releases/download/v1.0.0/app-release.apk")
    }
    soundType="mechanical"
    className="mt-6 flex-row items-center justify-center gap-2.5 rounded-2xl px-6 py-3.5 bg-slate-900 dark:bg-violet-600 border border-white/5 dark:border-white/10"
      ...
      >
        <Animated.View style={[{ opacity: missionAnim.opacity, transform: missionAnim.transform }, S.mb20]}>
          ...
          >
            ...
            <View style={{ flexDirection: "row", alignItems: "center", gap: 10, marginBottom: 10 }}>
              ...
              <Text style={{ color: "white", fontWeight: "800", fontSize: 16 }}>{t.about?.mission || "Our Mission"}</Text>
            </View>
        ...
        <Animated.View style={{ opacity: statsAnim.opacity, transform: statsAnim.transform }}>
          ...
          <View style={[{ flexDirection: "row" }, S.gap10, S.mb24]}>
            <StatBox value="10+" label={t.about?.languages || "Languages"} color="#8B5CF6" delay={460} />
            <StatBox value="5" label={t.about?.healthTools || "Tools"} color="#EF4444" delay={490} />
            <StatBox value="5" label={t.about?.gAssistFeatures || "Features"} color="#6366F1" delay={520} />
            <StatBox value="24/7" label={t.about?.aiSupport || "Support"} color="#10B981" delay={550} />
          </View>
        </Animated.View>
        ...
        <Animated.View style={{ opacity: ctaAnim.opacity, transform: ctaAnim.transform }}>
          ...
          >
            ...
            >
              <Text style={{ color: "white", fontWeight: "700", fontSize: 14 }}>{t.about?.contactUs || "Contact Us"}</Text>
            </AnimatedPressable>
          </View>
        </Animated.View>
      </View>
