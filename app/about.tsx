  ...
  return (
    <Animated.View style={[anim, { flex: 1 }]}>
      <Pressable
        ...
        style={{
          transform: [{ scale }], borderRadius: 18,
        ...
        className="dark:bg-[#1E293B] dark:border-[#334155]"
      >
        <View style={{ width: 48, height: 48, borderRadius: 16, backgroundColor: color, alignItems: "center", justifyContent: "center", marginBottom: 8, shadowColor: color, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 8, elevation: 4 }}>
  ...
  return (
    <Animated.View style={[anim, { flex: 1 }]}>
      <Pressable
        ...
        onHoverIn={() => Animated.spring(scale, { toValue: 1.05, useNativeDriver: true, speed: 28, bounciness: 8 }).start()}
        onHoverOut={() => Animated.spring(scale, { toValue: 1, useNativeDriver: true, speed: 22, bounciness: 8 }).start()}
        style={{ transform: [{ scale }], borderRadius: 18, backgroundColor: color, padding: 16, alignItems: "center", shadowColor: color, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.32, shadowRadius: 10, elevation: 5 }}
      >
...
export default function AboutUs() {
  ...
  return (
    ...
    >
      ...
      {/* Mission */}
      <Animated.View style={[missionAnim, { marginBottom: 20 }]}>
        <View style={{ backgroundColor: "#8B5CF6", borderRadius: 20, padding: 20, overflow: "hidden", shadowColor: "#8B5CF6", shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.3, shadowRadius: 14, elevation: 6 }}>
      ...
      <Animated.View style={valuesAnim}>
        <Text style={{ fontSize: 11, fontWeight: "700", letterSpacing: 1.2, color: "#8B5CF6", marginBottom: 12, marginTop: 8, marginLeft: 4 }}>{t.about.ourValues.toUpperCase()}</Text>
      ...
      <Animated.View style={ctaAnim}>
        <View style={{ backgroundColor: "white", borderRadius: 20, padding: 20, alignItems: "center", borderWidth: 1, borderColor: "#E2E8F0", shadowColor: "#000", shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.07, shadowRadius: 10, elevation: 3 }}
          className="dark:bg-[#1E293B] dark:border-[#334155]">
          ...
          <Text style={{ fontSize: 17, fontWeight: "800", color: "#0F172A", marginBottom: 4 }} className="dark:text-white">{t.about.getInTouch}</Text>
          <Text style={{ color: "#64748B", fontSize: 13, textAlign: "center", marginBottom: 16 }} className="dark:text-[#94A3B8]">{t.about.getInTouchDesc}</Text>
          <AnimatedPressable
            onPress={() => Linking.openURL("mailto:support@jansathi.in")}
            soundType="mechanical"
            style={{ backgroundColor: "#8B5CF6", paddingHorizontal: 28, paddingVertical: 12, borderRadius: 14, shadowColor: "#8B5CF6", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 8, elevation: 4 }}
          >
