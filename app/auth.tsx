  ...
  return (
    <View className="flex-1 bg-background items-center justify-center px-5">
      <View className="items-center mb-6">
        ...
        <Text className="text-2xl font-bold text-foreground">Welcome to JanSathi</Text>
      ...
      <View className="flex-row w-full mb-4">
        <Pressable
          ...
          className={`flex-1 py-2 rounded-l-lg ${mode === "signin" ? "bg-primary" : "bg-card"}`}
        >
          <Text className={`text-center font-semibold ${mode === "signin" ? "text-white" : "text-foreground"}`}>
            Sign In
          </Text>
        </Pressable>
        <Pressable
          onPress={() => setMode("signup")}
          className={`flex-1 py-2 rounded-r-lg ${mode === "signup" ? "bg-primary" : "bg-card"}`}
        >
          <Text className={`text-center font-semibold ${mode === "signup" ? "text-white" : "text-foreground"}`}>
            Sign Up
          </Text>
        </Pressable>
      </View>
